...
<img src="{{  asset('/storage/images/' . Auth::user()->images) }}">
            <input name="newPost" placeholder="投稿内容を入力してください"><button type="submit"><img src="images/post.png"></button></input>
...
<p><td class="username">{{ $post->user->username }}</td><!--リレーションしたやつはテーブル名も書く必要がある--></p>
